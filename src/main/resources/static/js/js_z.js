$(function () {
    ...
    $('.down li:nth-child(2n+1)').css('background', '#E6F6FF');
    $('.pro li:nth-child(2n)').css('margin-right', 0);
    $('.pro_a li:nth-child(3n)').css('margin-right', 0);
    $('.relative ul li:nth-child(3n)').css('margin-right', 0);
    $('.pro_b li:nth-child(4n)').css('margin-right', 0);
    $('.pro_b li:nth-child(3n)').css('margin-right', 9 + 'px');
